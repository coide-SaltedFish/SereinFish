package sereinfish.bot.entity.motion.xiaomi;

import com.alibaba.fastjson.JSONObject;
import okhttp3.Response;
import sereinfish.bot.utils.BotUtils;
import sereinfish.bot.utils.DateTimeFormatterUtils;
...
public class XiaoMiMotion {
    private final static String ua = "Dalvik/2.1.0 (Linux; U; Android 10; V1914A Build/QP1A.190711.020)";
     ...
     * @throws IOException
     */
    public static Result<String> login(String phone, String password) throws IOException {
...
//        map.put("token", "refresh");
     ...
     * @throws IOException
     */
    public static String changeStep(String token, int step) throws IOException {
    ...
    private static Result<Map<String, String>> getInfo(String token) throws IOException {
