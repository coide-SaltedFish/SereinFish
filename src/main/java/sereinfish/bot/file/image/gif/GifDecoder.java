package sereinfish.bot.file.image.gif;
...
public class GifDecoder {
    ...
    /**
     * 获取“Netscape”迭代计数（如果有）。计数为0表示不确定地重复。
     *
     ...
     * 获取第n帧的图像内容。
     *
     * @return 帧的BuffereImage表示，如果n无效，则为null。
     */
     ...
     * 从指定的 file/URL 源读取GIF文件（如果名称包含“:/”或“file:”，则假定为URL）
     *
    ...
    /**
     * 将LZW图像数据解码成像素阵列。改编自约翰·克里斯蒂的ImageMagick。
     */
